...
import { PageInfo } from '@app/users/models/page-info'
import { PaginationArgs } from '@app/users/models/pagination.args';
...
export async function paginate<T>(
	...
	if (paginationArgs.first) {
		...
		if (paginationArgs.after) {
			...
			console.log("  ")
			console.log("  ")
			console.log(paginationArgs.after)
			console.log(Buffer.from(paginationArgs.after, 'base64'))
			console.log(Buffer.from(paginationArgs.after, 'base64'))
			console.log(Buffer.from(paginationArgs.after, 'base64').toString('ascii'))
